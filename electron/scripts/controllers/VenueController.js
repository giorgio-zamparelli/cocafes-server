app.controller('VenueController', [ '$rootScope', '$scope', '$routeParams', '$location', '$interval', 'Api', function($rootScope, $scope, $routeParams, $location, $interval, Api) {
    ...
    var intervalVenue = $interval(getVenue, 60000);
    $scope.$on('$destroy', function () { $interval.cancel(intervalVenue); });
